...
def create_results_table():
    with engine.begin() as conn:
        ...
        conn.execute(text("""
            CREATE INDEX IF NOT EXISTS idx_test_results_client_project 
            ON test_results(client_id, project_id)
        """))
        ...
        conn.execute(text("""
            CREATE INDEX IF NOT EXISTS idx_upload_metadata_client_project 
            ON upload_metadata(client_id, project_id)
        """))
